...
import { Plus, Search, Eye, Trash2, Pause, Play, Filter, Pencil, Archive, Briefcase } from 'lucide-react'
...
export default function LateralHiringPage() {
  ...
  // Filter to lateral campaigns only (LATERAL is the default for all existing campaigns)
  const campaigns = allCampaigns.filter((c: any) => c.hiringType === 'LATERAL' || !c.hiringType)
      ...
      <div className="section-header">
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
            <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'linear-gradient(135deg,var(--orange),var(--red))', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
